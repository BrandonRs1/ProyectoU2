public class UserController implements ControllerCom {
    ...
    public void create() {
        ...
        //this.addToArray(user);
    }

    /**
     * This method is using to delete administrators
     */
    @Override
    public void delete() {
    ...
    /**
     * This method is using to edit administrators
     */
    @Override
    public void edit() {
    }
    ...
    /**
     * This method is to print the arrayList
     */
    @Override
