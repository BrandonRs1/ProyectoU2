...
/**
 * All the fucking class will be uss only for the fucking administrators
 */
public class MainController {
    ...
    /**
     * This is the main menu of clients
     *
     * @return the option that the client chose
     */
    ...
    /**
     * This is the main switch for clients
     *
     * @param option is the option that the client chose
     */
    ...
    /**
     * This is the switch of the main menu
     *
     * @param option is the option that the admin chose
     */
